...
export type SearchRequest = {
    /**
     * Restrict results to these APIs. Each entry is a 'vendor[/name[/version]]' identifier of an imported API (e.g. 'github-com/api-github-com/1.1.4'); the legacy colon-separated form 'vendor[:name[:version]]' is also accepted.
     */
