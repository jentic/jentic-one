...
/**
 * Inline two-step confirm for destructive row actions (suspend / permanently
 * unbind a credential binding). The trigger arms an inline "are you sure?"
 * group, and confirming fires `onConfirm`. Focus moves to the confirm button
 * on arm so the destructive action is reachable from the keyboard.
 *
