...
// isolated Unix user — `jentic setup`, `jentic run`, agent-account
...
// local-agent method — SetupForWizard, SkillUpdateDefault — construct a Cmd
...
// shared *cmdcore.App (NewSetupCmd/NewRunCmd take *cmdcore.App and wrap it).
//
